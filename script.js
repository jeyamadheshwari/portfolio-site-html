...
document.querySelectorAll('.image-nav-buttons .nav-btn').forEach(button => {
    button.addEventListener('click', () => {
        const imageContainer = button.closest('.project-image-slider').querySelector('.project-images');
        const images = Array.from(imageContainer.querySelectorAll('.project-img'));
        const activeImage = imageContainer.querySelector('.project-img.active');
        let activeIndex = images.indexOf(activeImage);
